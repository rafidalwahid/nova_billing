    ...
    public function run(): void
    {
        $modules = [
            ...
            'Support Ticket System' => [
                ...
                'Create Support Tickets' => 'Create new support tickets for customers and internal issues',
                'Edit Support Tickets' => 'Modify ticket details, priority, category, and assignment information',
                'Delete Support Tickets' => 'Remove spam, duplicate, or inappropriate tickets from the support system',
                'Assign Support Tickets' => 'Assign tickets to staff members and departments for resolution',
                'Manage Ticket Status' => 'Change ticket status between open, in progress, resolved, and closed',
                'View Ticket Responses' => 'Access all responses and communication within support tickets',
                'Create Ticket Responses' => 'Reply to customer inquiries and provide support through the ticket system',
                'Edit Ticket Responses' => 'Modify existing ticket responses and communication history',
                'Delete Ticket Responses' => 'Remove inappropriate or incorrect responses from tickets',
                'View Internal Notes' => 'Access internal staff notes and private ticket information',
